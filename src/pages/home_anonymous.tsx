...
const UniverseQuestionForm: React.FC<UniverseQuestionFormProps> = ({ question, setQuestion, askUniverse }) => {
  return (
...
const RecentQuestions: React.FC<RecentQuestionsProps> = ({ question, answer, handleShareImage }) => {
  return (
    <div className="mt-8">
      
      <div className="mb-6 p-4 bg-white rounded-lg shadow-md" id="canvas">
      <div className="flex items-center justify-center" >
        <span className="whitespace-nowrap text-xl font-semibold dark:text-white">DSIDER APP</span>
        <img
          src={Logo.src}
          style={{ width: 50, height: 50 }}
      ...
      <div>
        ...
        <p
          className={`font-bold text-lg ${answer === 'Yes' ? 'text-green-500' : 'text-red-500'}`}
        >
          {answer}
        </p>
      </div>
